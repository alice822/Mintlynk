...
namespace MintLynk.Web.Areas.Dashboard.Controllers
{
    ...
    public class AnalyticsController : Controller
    {
        ...
        public AnalyticsController(ILogger<AnalyticsController> logger, IUrlShorteningService urlShorteningService, IConfiguration configuration, ILinkStatsService linkStatsService)
        {
            _logger = logger;
